...
// this route is about: GET api/v1/universities/{id}/classrooms
router.get(
    "/:id/classrooms",
    isAuth(),
    universitiesMiddleware.handleAllowedMethods,
    universitiesController.getClassrooms
);

// this route is about: GET api/v1/universities/{id}/professors
router.get(
    "/:id/professors",
    isAuth(),
    universitiesMiddleware.handleAllowedMethods,
